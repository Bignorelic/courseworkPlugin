...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<CourseworkPluginAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<CourseworkPluginAudioProcessor::BlockType>* leftChannelFifo;
